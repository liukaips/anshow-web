...
const payload = { homes: { en: { locale: "en", headline: "Preview", slides: [], services: [], tradeLanes: [], cargoTypes: [], proof: [], verifiedTrust: [], certificates: [], cases: [], articles: [], channels: [] }, zh: { locale: "zh", headline: "预览", slides: [], services: [], tradeLanes: [], cargoTypes: [], proof: [], verifiedTrust: [], certificates: [], cases: [], articles: [], channels: [] }, ru: { locale: "ru", headline: "Предпросмотр", slides: [], services: [], tradeLanes: [], cargoTypes: [], proof: [], verifiedTrust: [], certificates: [], cases: [], articles: [], channels: [] } }, collections: { services: { en: [], zh: [], ru: [] }, "trade-lanes": { en: [], zh: [], ru: [] }, "special-cargo": { en: [], zh: [], ru: [] }, insights: { en: [], zh: [], ru: [] }, "case-studies": { en: [], zh: [], ru: [] }, pages: { en: [], zh: [], ru: [] } }, sitemap: [] } as const;
